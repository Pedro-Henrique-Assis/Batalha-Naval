...
public class Fragata extends Embarcacao implements PodeAtirarSimples, PodeAtirarDuplo {
    public Fragata(List<Coordenada> posicoes, Dificuldade dificuldade) {
        super("Fragata", 4, posicoes, dificuldade);
    }
